...
public class ModularWindow : MonoBehaviour
{

    public List<SKUIElement> all_UIElements = new List<SKUIElement>();
    ...
    //    Vector2 canvasSize = Shopkeeper.UI.rt_GameCanvas.sizeDelta;
    //    Vector2 netSizeLimit = canvasSize - sizeWindow;

    //    pos.x = Shopkeeper.UI.inGame_borderMin.x;
    //    pos.y = Shopkeeper.UI.inGame_borderMin.y;
